...
def load_data(image_folder, ann_folder, target_size=(224, 224)):
    ...
    Args:
        ...
        ann_folder (str): Path to the folder containing annotation JSON files.
        target_size (tuple): Target size to resize images (default: (224, 224)).

    Returns:
        images (list): List of images.
        annotations (list): List of scaled annotations.
    """
    images = []
    annotations = []
